...
import MaintenanceRequestForm from '../../components/SubmitMaintenanceRequest';

const StaffLayout: React.FC = function () {
  return (
    <>
      <div className="flex h-full">
        ...
        <div className="flex-1 p-5 bg-gray-50 overflow-y-scroll h-full lg:ml-64">
          <Routes>
            ...
            <Route path="/new-req" element={<MaintenanceRequestForm />} />
          </Routes>
        </div>
      </div>
      {/* Mobile Sidebar */}
